...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}BannedIP]') and name='PK_{objectQualifier}BannedIP')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Category]') and name='PK_{objectQualifier}Category')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}CheckEmail]') and name='PK_{objectQualifier}CheckEmail')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Choice]') and name='PK_{objectQualifier}Choice')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Forum]') and name='PK_{objectQualifier}Forum')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}ForumAccess]') and name='PK_{objectQualifier}ForumAccess')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}MessageReported]') and name='PK_{objectQualifier}MessageReported')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Group]') and name='PK_{objectQualifier}Group')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}GroupMedal]') and name='PK_{objectQualifier}GroupMedal')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}ForumReadTracking]') and name='PK_{objectQualifier}ForumReadTracking')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}TopicReadTracking]') and name='PK_{objectQualifier}TopicReadTracking')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}UserMedal]') and name='PK_{objectQualifier}UserMedal')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Mail]') and name='PK_{objectQualifier}Mail')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}UserProfile]') and name='PK_{objectQualifier}UserProfile')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Message]') and name='PK_{objectQualifier}Message')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}PMessage]') and name='PK_{objectQualifier}PMessage')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}PollGroupCluster]') and name='PK_{objectQualifier}PollGroupCluster')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Poll]') and name='PK_{objectQualifier}Poll')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Smiley]') and name='PK_{objectQualifier}Smiley')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Topic]') and name='PK_{objectQualifier}Topic')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}FavoriteTopic]') and name='PK_{objectQualifier}FavoriteTopic')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}User]') and ( name='PK_{objectQualifier}User' OR name='PK_{objectQualifier}{objectQualifier}User' ) )
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}WatchForum]') and name='PK_{objectQualifier}WatchForum')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}WatchTopic]') and name='PK_{objectQualifier}WatchTopic')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}UserGroup]') and name='PK_{objectQualifier}UserGroup')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Rank]') and name='PK_{objectQualifier}Rank')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}NntpServer]') and name='PK_{objectQualifier}NntpServer')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}NntpForum]') and name='PK_{objectQualifier}NntpForum')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}NntpTopic]') and name='PK_{objectQualifier}NntpTopic')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}AccessMask]') and name='PK_{objectQualifier}AccessMask')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}UserForum]') and name='PK_{objectQualifier}UserForum')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Board]') and name='PK_{objectQualifier}Board')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Active]') and name='PK_{objectQualifier}Active')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}UserPMessage]') and name='PK_{objectQualifier}UserPMessage')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Attachment]') and name='PK_{objectQualifier}Attachment')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}PollVote]') and name='PK_{objectQualifier}PollVote')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}IgnoreUser]') and name='PK_{objectQualifier}IgnoreUser')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}ShoutboxMessage]') and name='PK_{objectQualifier}ShoutboxMessage')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}Thanks]') and name='PK_{objectQualifier}Thanks')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}MessageHistory]') and name='PK_{objectQualifier}MessageHistory')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}ActiveAccess]') and name='PK_{objectQualifier}ActiveAccess')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}ReputationVote]') and name='PK_{objectQualifier}ReputationVote')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}AdminPageUserAccess]') and name='PK_{objectQualifier}AdminPageUserAccess')
...
if not exists (select top 1 1 from  sys.indexes where object_id=object_id('[{databaseOwner}].[{objectQualifier}EventLogGroupAccess]') and name='PK_{objectQualifier}EventLogGroupAccess')
